...
class FormPrueba(Form):
    def __init__(self, screen, x, y, w, h, color_background, color_border="Black", border_size=-1, active=True):
        ...
        ##Controles
        self.txtbox = TextBox(self._slave, x, y, 80, 790, 275, 50, "white", "white", "black", "Green", 2, font= "Comic Sans", font_size=25, font_color="black")
        ...
        self.label_volumen = Label(self._slave, 1310, 785, 50, 50, "20%", "Comic Sans", 15, "Black", "Table.png")
        self.slider_volumen = Slider(self._slave, x, y, 1050, 800, 250, 15, self.volumen, "GRAY", "White")
    ...
    def render(self):
        image = pygame.image.load("Recursos\Menu\Fondo_menu.png")
