...
class FormMenu(Form):
    def __init__(self, screen, x,y,w,h, color_background, color_border, active, path_image, score, margen_y, margen_x, espacio):
        ...
        lbl_jugador = Label(self._slave, x=margen_x + 10, y=20, w=w/2-margen_x-10, h=50, text="Jugador", font="Verdana", font_size=30, font_color="Black", path_image= "Interfaz/bar.png")

        lbl_puntuaje = Label(self._slave, x=margen_x + 10 + w/2-margen_x-10, y=20, w=w/2-margen_x-10, h=50, text="Puntuaje", font="Verdana", font_size=30, font_color="Black", path_image= "Interfaz/bar.png")
        ...
        for j in self._score:
            ...
            for n,s in j.items():
                cadena = ""
                cadena = f"{s}"
                jugador = Label(self._slave, pos_inicial_x, pos_inicial_y,w/2-margen_x, 100, cadena, "Verdana", 30, "Black", "Interfaz\Table.png")
